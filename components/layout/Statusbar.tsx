...
export function Statusbar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-8 bg-s1 border-t border-b1">
      <div className="flex items-center justify-between h-full px-8 text-t3 text-sm font-mono gap-8">
